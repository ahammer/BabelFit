...
/**
 * Tracks token usage and estimated cost across all requests for a BabelFit instance.
 *
 * Automatically registered as a [RequestListener] on every [BabelFitInstance].

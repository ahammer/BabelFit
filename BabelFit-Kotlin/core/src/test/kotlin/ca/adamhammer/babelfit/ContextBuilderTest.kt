...
class ContextBuilderTest {
    ...
    fun `DefaultContextBuilder produces system instructions`() {
        ...
        val descriptor = MethodDescriptor.from(method, listOf("Alice"), Greeting::class)
        val request = BabelFitRequest(descriptor, emptyMap(), Greeting::class)
    ...
    fun `DefaultContextBuilder passes memory through without embedding in invocation`() {
        ...
        val descriptor = MethodDescriptor.from(method, listOf("Alice"), Greeting::class)
        val request = BabelFitRequest(descriptor, memory, Greeting::class)

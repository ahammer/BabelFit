...
The `babelfit-core` module provides the foundation for the BabelFit AI proxy library. It contains zero AI-provider dependencies and defines the core abstractions for building type-safe AI clients in Kotlin.

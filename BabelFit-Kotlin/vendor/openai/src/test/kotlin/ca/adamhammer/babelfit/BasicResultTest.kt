...
class AiApiBabelFitTest {
    ...
    @Test
    fun testStubApi() {
        val api = BabelFitBuilder(QuestionAPI::class)
        ...
        assertNotNull(answer, "There is no answer for the babelfit")
    }

    @Test
    @Tag("live")
    fun testJsonApi() {
        val answer = BabelFitBuilder(QuestionAPI::class)

...
import ca.adamhammer.babelfit.utils.toJsonClassMetadataString
...
suspend fun <T : Any> DecidingAgentAPI.decideSuspend(babelfitInstance: BabelFitInstance<T>): AiDecision =
    withContext(Dispatchers.IO) { decide(babelfitInstance).get() }

package ca.adamhammer.babelfit.mcp
 ...
 * ```
 */
class BabelFitMcpServer private constructor(
    ...
    class Builder {
        private val logger = Logger.getLogger(BabelFitMcpServer::class.java.name)
        private var transportProvider: McpServerTransportProvider? = null
        private var serverName: String = "babelfit-mcp-server"
        ...
        fun build(): BabelFitMcpServer {
            ...
            return BabelFitMcpServer(spec.build())
        }

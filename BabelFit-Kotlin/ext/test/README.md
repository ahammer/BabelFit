...
The `babelfit-test` module provides everything you need for offline testing of BabelFit interfaces and prompt pipelines.
...
val (api, mock) = babelFitTest<MyAPI>(mock)
api.get().get()
